...
export default function Letter() {
    ...
    const letterText = `Dear Pratyush (cr4ck j4ck),

Happy Birthday bhai! 🎉
Aaj ka din sirf tera hai – ekdum royal treatment milna chahiye tujhe!
Tere jaisa doston mein ek hi hota hai – asli crack jack! 😎

jab tere se mila bhai kasam se usdin kush tha bhai kya banda hai tu . Tu hamesha sabko energy deta hai aur ek alag hi level ka swag lekar aata hai. Tera sense of humor, tera attitude, aur tera dil – sab first class hai.

Mujhe lagta hai zindagi ke har level pe tu ek winner hai, bas game chalti rehni chahiye. Har saal ki tarah is baar bhi tujhe sirf cake khilane nahi, ek naye level ka celebration milna chahiye.

Chahe life mein kitni bhi "lag" aaye ya "glitch" ho, tu toh OP hai hi – sab handle kar lega. 😄

Bas isi tarah hustle karta reh, maze le aur apne naam ke jaise duniya mein ek "jackpot" ban ja! Teri har wish fullfile ho, aur success tera permanent teammate ban ja.

Once again, Happy Birthday bhai!
Party hard, aur agar kuch bacha to humein bhi bula lena 😜🎂
